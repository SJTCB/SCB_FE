...
export const fetchBoardList = async () => {
    try {
        const response = await api.get('api/board/boards/');
...
export const createBoard = async (data) => {
    try {
        const response = await api.post('api/board/boards/', data);
        return response.data;
    } catch (error) {
...
export const fetchBoardDetails = async (id) => {
    try {
        const response = await api.get(`api/board/boards/${id}/`);
        return response.data;
    } catch (error) {
...
export const updateBoard = async (id, data) => {
    try {
        const response = await api.patch(`api/board/boards/${id}/`, data);
        return response.data;
    } catch (error) {
...
export const deleteBoard = async (id) => {
    try {
        const response = await api.delete(`api/board/boards/${id}/`);
